  ...
  return function(moduleArg = {}) {
    ...
    Module.runSQLite3PostLoadInit = function(EmscriptenModule) {
        ...
        delete globalThis.Jaccwabyt;
        {
          ...
          wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)(
            ...
            (v2) => {
              var _a;
              return __xArgPtr(
                v2 instanceof (((_a = sqlite3 == null ? void 0 : sqlite3.oo1) == null ? void 0 : _a.Stmt) || nilType) ? v2.pointer : v2
              );
            }
          )(
            "sqlite3*",
            (v2) => {
              var _a;
              return __xArgPtr(
                v2 instanceof (((_a = sqlite3 == null ? void 0 : sqlite3.oo1) == null ? void 0 : _a.DB) || nilType) ? v2.pointer : v2
              );
            }
          )("sqlite3_vfs*", (v2) => {
            if ("string" === typeof v2) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        sqlite3.version = {
          libVersion: "3.50.3",
          libVersionNumber: 3050003,
          sourceId: "2025-07-17 13:25:10 3ce993b8657d6d9deda380a93cdd6404a8c8ba1b185b2bc423703e41ae5f2543",
          downloadVersion: 3500300
        };
      });
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        const toss = (...args) => {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        ...
        class OpfsSAHPool {
          ...
          pauseVfs() {
            if (__privateGet(this, _mapS3FileToOFile_).size > 0) {
              sqlite3.SQLite3Error.toss(
                capi.SQLITE_MISUSE,
                "Cannot pause VFS",
                this.vfsName,
          ...
          async unpauseVfs() {
            if (0 === __privateGet(this, _mapSAHToName).size) {
              return this.acquireAccessHandles(false).then(
                () => capi.sqlite3_vfs_register(__privateGet(this, _cVfs), 0),
                this
              );
            }
            return this;
...
export {
  sqlite_wasm_default as default,
  sqlite3Worker1Promiser2 as sqlite3Worker1Promiser
};
